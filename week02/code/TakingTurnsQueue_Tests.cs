...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The people were being added at the beginning of the "queue" instead of at the end
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The infinity person wasn't being added in a infinity amount of times.
